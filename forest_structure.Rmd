...
plot5 <- ggplot(stand_mets, aes(habitat, mean.dbh, color = habitat)) + 
  geom_boxplot(outlier.shape = NA) +
  geom_jitter(width = 0.1) + 
  labs(title = "tree dbh", x = "", y = "dbh (cm)") + 
  coord_flip() + 
  theme_classic() +
  theme(axis.text.y = element_blank(),
        plot.title = element_text(hjust = 0.5),
...
plot9 <- ggplot(stand_mets, aes(habitat, pts.below.2m, color = habitat)) + 
  geom_boxplot(outlier.shape = NA) +
  geom_jitter(width = 0.1) + 
  labs(title = "terr. vegetation", x = "", y = "n mil. pts. < 2 m") + 
  coord_flip() + 
  theme_classic() +
  theme(plot.title = element_text(hjust = 0.5),
...
p13 <- ggplot(stand_mets, aes(altitude, vFRcanopy)) + 
  geom_point() +
  geom_smooth(se = TRUE) +
  labs(title = "veg. vol.", x = "elevation (m)", y = "vegetated:all voxels") + 
  theme_classic() +
  theme(plot.title = element_text(hjust = 0.5))
```
...
p14 <- ggplot(stand_mets, aes(altitude, vzrumple)) + 
  geom_point() +
  geom_smooth(se = TRUE) +
  labs(title = "vert. pt. complex..", x = "elevation (m)", y = "vert. rumple index") + 
  theme_classic() +
  theme(plot.title = element_text(hjust = 0.5))
```
...
p15 <- ggplot(stand_mets, aes(altitude, ClosedGapSpace)) + 
  geom_point() +
  geom_smooth(se = TRUE) +
  labs(title = "gap volume", x = "elevation (m)", y = "gap volume") + 
  theme_classic() +
  theme(plot.title = element_text(hjust = 0.5))
```
