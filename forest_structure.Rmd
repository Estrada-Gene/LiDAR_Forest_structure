...
#by elevation
p9 <- ggplot(stand_mets, aes(altitude, pts.below.2m)) + 
  geom_point() +
  geom_smooth(se = TRUE) +
  labs(title = "terrestrial veg.", x = "", y = "n mil. pts. < 2 m") + 
  theme_classic() +
...
t1 <- ggplot(tree_mets, aes(h)) +
  ...
  geom_vline(aes(xintercept = mean_h), color = "grey10", size = 1) +
  geom_vline(aes(xintercept = mean_h + sd_h), color = "grey", linetype = "dashed", size = 0.8) +
  geom_vline(aes(xintercept = mean_h - sd_h), color = "grey", linetype = "dashed", size = 0.8) +
...
t2 <- ggplot(tree_mets, aes(dbh)) +
  geom_histogram(bins = 100) +
  geom_vline(aes(xintercept = mean_dbh), color = "grey10", size = 1) +
  geom_vline(aes(xintercept = mean_dbh + sd_dbh), color = "grey", linetype = "dashed", size = 0.8) +
  geom_vline(aes(xintercept = mean_dbh - sd_dbh), color = "grey", linetype = "dashed", size = 0.8) +
...
t3 <- ggplot(tree_mets, aes(v)) +
  geom_histogram(bins = 100) +
  geom_vline(aes(xintercept = mean_v), color = "grey10", size = 1) +
  geom_vline(aes(xintercept = mean_v + sd_v), color = "grey", linetype = "dashed", size = 0.8) +
  geom_vline(aes(xintercept = mean_v - sd_v), color = "grey", linetype = "dashed", size = 0.8) +
  #annotate("text", x = 1.5, y = 400, label = paste("mean:", round(mean_v, 2), 
  #                                                  "\nSD:", round(sd_v, 2)),
  #         hjust = 0.8, size = 2, color = "grey10") +
  labs(title = "tree volume", x = expression(volume~(m^3)), y = "") +
  theme_classic() +
  theme(plot.title = element_text(hjust = 0.5)) +
  xlim(0,2)
...
t1 <- ggplot(tree_mets, aes(x = altitude, y = h)) +
  geom_point() +
  geom_smooth(se = TRUE) +
  #geom_hline(aes(yintercept = mean_h), color = "grey10", size = 1) +
  #geom_hline(aes(yintercept = mean_h + sd_h), color = "grey", linetype = "dashed", size = 0.8) +
  #geom_hline(aes(yintercept = mean_h - sd_h), color = "grey", linetype = "dashed", size = 0.8) +
  labs(title = "tree height", x = "", y = "height (m)") + 
  theme_classic() +
  theme(plot.title = element_text(hjust = 0.5))
...
t2 <- ggplot(tree_mets, aes(x = altitude, y = dbh)) +
  geom_point() +
  geom_smooth(se = TRUE) +
  #geom_hline(aes(yintercept = mean_dbh), color = "grey10", size = 1) +
  #geom_hline(aes(yintercept = mean_dbh + sd_dbh), color = "grey", linetype = "dashed", size = 0.8) +
  #geom_hline(aes(yintercept = mean_dbh - sd_dbh), color = "grey", linetype = "dashed", size = 0.8) +
...
t3 <- ggplot(tree_mets, aes(x = altitude, y = v)) +
  geom_point() +
  geom_smooth(se = TRUE) +
  labs(title = "tree volume", x = "", y = expression(volume~(m^3))) + 
  theme_classic() +
  theme(plot.title = element_text(hjust = 0.5)) + 
  ylim(0, 2)
