...
plot11 <- ggplot(stand_mets, aes(habitat, zentropy, color = habitat)) + 
  geom_boxplot(outlier.shape = NA) +
  geom_jitter(width = 0.1) + 
  labs(title = "vertical pt. dist.", x = "", y = "vert. entropy") + 
  coord_flip() + 
  theme_classic() +
  theme(plot.title = element_text(hjust = 0.5, size = title_size),
        legend.position = "none",
...
p11 <- ggplot(stand_mets, aes(altitude, zentropy, color = habitat)) + 
  ...
  geom_smooth(se = TRUE, aes(color = NULL)) +
  scale_color_manual(values = ft_colors) +
  labs(title = "vertical pt. dist.", x = "elevation (m)", y = "vert. entropy") + 
  theme_classic() +
  theme(plot.title = element_text(hjust = 0.5, size = title_size),
        axis.title.y = element_text(size = axis_title_size),
        legend.position = "none")
...
#by forest type
plot10 <- ggplot(stand_mets, aes(habitat, vFRcanopy, color = habitat)) + 
  geom_boxplot(outlier.shape = NA) +
  geom_jitter(width = 0.1) + 
  labs(title = "veg. vol.", x = "", y = "m³") + 
  coord_flip() + 
  theme_classic() +
  theme(plot.title = element_text(hjust = 0.5, size = title_size),
        legend.position = "none",
...
#by elevation
p10 <- ggplot(stand_mets, aes(altitude, vFRcanopy, color = habitat)) + 
  geom_point() +
  geom_smooth(se = TRUE, aes(color = NULL)) +
  scale_color_manual(values = ft_colors) +
  labs(title = "veg. vol.", x = "", y = "m³") + 
...
plot12 <- ggplot(stand_mets, aes(habitat, vzrumple, color = habitat)) + 
  geom_boxplot(outlier.shape = NA) +
  geom_jitter(width = 0.1) + 
  labs(title = "vertical pt. complex.", x = "", y = "vert. rumple") + 
  coord_flip() + 
  theme_classic() +
  theme(plot.title = element_text(hjust = 0.5, size = title_size),
        axis.text.y = element_blank(),
