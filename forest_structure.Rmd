...
t1 <- ggplot(tree_mets, aes(h)) +
  ...
  #geom_vline(aes(xintercept = mean_h), color = "grey20", size = 1) +
...
t2 <- ggplot(tree_mets, aes(dbh)) +
  geom_histogram(bins = 100) +
  #geom_vline(aes(xintercept = mean_dbh), color = "grey20", size = 1) +
  ...
  #                                                  "\nSD:", round(sd_dbh, 2)),
  #         hjust = 0.8, size = 4, color = "grey10") +
  labs(title = "tree diameter", x = "DBH (cm)", y = "") +
  theme_classic() +
  theme(plot.title = element_text(hjust = 0.5))
...
t3 <- ggplot(tree_mets, aes(v)) +
  geom_histogram(bins = 100) +
  #geom_vline(aes(xintercept = mean_v), color = "grey20", size = 1) +
  #geom_vline(aes(xintercept = mean_v + sd_v), color = "grey", linetype = "dashed", size = 0.8) +
  #geom_vline(aes(xintercept = mean_v - sd_v), color = "grey", linetype = "dashed", size = 0.8) +
  #annotate("text", x = 10, y = 400, label = paste("mean:", round(mean_v, 2), 
  #                                                  "\nSD:", round(sd_v, 2)),
...
ggplot(tree_mets, aes(x = habitat, y = dbh)) +
  ...
  geom_boxplot(width = 0.3) +
  #geom_jitter(width = 0.1) + 
  labs(title = "tree diameter", x = "", y = "dbh (cm)") + 
  coord_flip() + 
  theme_classic()
...
t2 <- ggplot(tree_mets, aes(x = altitude, y = dbh)) +
  geom_point() +
  geom_smooth(se = TRUE) +
  labs(title = "tree diameter", x = "elevation (m)", y = "dbh (cm)") + 
  theme_classic() +
  theme(plot.title = element_text(hjust = 0.5))
...
t3 <- ggplot(tree_mets, aes(x = altitude, y = v)) +
  geom_point() +
  geom_smooth(se = TRUE) +
  labs(title = "tree volume", x = "elevation (m)", y = expression(volume~(m^3))) + 
  theme_classic()
  theme(plot.title = element_text(hjust = 0.5))
