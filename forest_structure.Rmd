...
stand_mets$partition <- factor(stand_mets$partition, 
                                       ...
                                       ordered = TRUE)
#all tree metrics
tree_mets <- read.csv(file = "all.tree.mets.csv", header = TRUE)
...
tree_mets$partition <- factor(tree_mets$partition, 
                                       ...
                                       ordered = TRUE)
#all stand metrics
all_stand_mets <- read.csv(file = "all.stand.mets.csv", header = TRUE)
...
p7 <- ggplot(stand_mets, aes(altitude, stand.dens)) + 
  geom_point() +
  geom_smooth(se = TRUE) +
  labs(title = "Tree Density", x = "elevation (m)", y = "trees/ha") + 
  theme_classic() +
  theme(plot.title = element_text(hjust = 0.5))
```
...
p8 <- ggplot(stand_mets, aes(altitude, stem.vol)) + 
  geom_point() +
  geom_smooth(se = TRUE) +
  labs(title = "Tree Volume", x = "elevation (m)", y = expression(m^3/ha)) + 
  theme_classic() +
  theme(plot.title = element_text(hjust = 0.5))
```
...
p9 <- ggplot(stand_mets, aes(altitude, perc.below.2m)) + 
  geom_point() +
  geom_smooth(se = TRUE) +
  labs(title = "Terrestrial Vegetation", x = "elevation (m)", y = "% veg. < 2 m") + 
  theme_classic() +
  theme(plot.title = element_text(hjust = 0.5))
```
...
#by forest type
ggplot(stand_mets, aes(habitat, zentropy)) + 
  geom_boxplot(outlier.shape = NA) +
  geom_jitter(width = 0.1) + 
...
#by elevation
ggplot(stand_mets, aes(altitude, zentropy)) + 
  geom_point() +
  geom_smooth(se = TRUE) +
  labs(title = "Vertical Complexity", x = "elevation (m)", y = "entropy (z)") + 
  theme_classic() +
  theme(plot.title = element_text(hjust = 0.5))
```
...
#by forest type
ggplot(stand_mets, aes(habitat, lad.max)) + 
  geom_boxplot(outlier.shape = NA) +
  geom_jitter(width = 0.1) + 
...
#by elevation
ggplot(stand_mets, aes(altitude, lad.max)) + 
  geom_point() +
  geom_smooth(se = TRUE) +
  labs(title = "Leaf Area Density", x = "elevation (m)", y = "LAD") + 
  theme_classic() +
  theme(plot.title = element_text(hjust = 0.5))
```
...
#by forest type
ggplot(stand_mets, aes(habitat, rumple)) + 
  geom_boxplot(outlier.shape = NA) +
  geom_jitter(width = 0.1) + 
...
#by elevation
ggplot(stand_mets, aes(altitude, rumple)) + 
  geom_point() +
  geom_smooth(se = TRUE) +
  labs(title = "Canopy Rugosity", x = "elevation (m)", y = "Rumple Index") + 
  theme_classic() +
  theme(plot.title = element_text(hjust = 0.5))
```
...
#by forest type
ggplot(stand_mets, aes(habitat, vFRcanopy)) + 
  geom_boxplot(outlier.shape = NA) +
  geom_jitter(width = 0.1) + 
...
#by elevation
ggplot(stand_mets, aes(altitude, vFRcanopy)) + 
  geom_point() +
  geom_smooth(se = TRUE) +
...
even after controlling for elevation there doesn't seem to be much variation here. Alone, this metric mirrors elevation, so I won't be able to use this for modeling
```{r}
#distribution
...
#by forest type
ggplot(stand_mets, aes(habitat, vzrumple/altitude)) + 
  geom_boxplot(outlier.shape = NA) +
  geom_jitter(width = 0.1) + 
...
#by partition
ggplot(stand_mets, aes(partition, vzrumple/altitude)) + 
  geom_boxplot(outlier.shape = NA) +
  geom_jitter(width = 0.1) + 
  labs(title = "Vertical Rumple", x = "", y = "Rumple Index") + 
  coord_flip() + 
...
#by elevation
ggplot(stand_mets, aes(altitude, vzrumple/altitude)) + 
  geom_point() +
  geom_smooth(se = TRUE) +
...
#by forest type
ggplot(stand_mets, aes(habitat, ClosedGapSpace)) + 
  geom_boxplot(outlier.shape = NA) +
  geom_jitter(width = 0.1) + 
...
#by elevation
ggplot(stand_mets, aes(altitude, ClosedGapSpace)) + 
  geom_point() +
  geom_smooth(se = TRUE) +
