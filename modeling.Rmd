...
#ggsave("adjCV_scales.jpg", plot = last_plot(), width = 6.5, height = 8, dpi = 500, device = "jpeg")
```
...
```{r}
#set order
metrics_order2 <- c("tree h max.", "tree h", "CRR", "tree h sd", "tree dbh", "basal area",
                    "tree dens.", "tree vol.", "n pts<2m", "v dist.", "LAD", "rumple", 
                    "veg. vol.", "v complex.", "gap vol.")
...
custom_titles <- c(
  ...
  #"basal area" = "Basal Area",
  "tree dens." = "tree density",
  "tree vol." = "tree volume",
  "n pts<2m" = "terrestrial veg.",
  "v dist." = "vertical pt. dist.",
  "LAD" = "leaf area density",
  "rumple" = "canopy roughness",
  "veg. vol." = "veg. volume",
  "v complex." = "vertical pt. complex.",
  "gap vol." = "gap volume")
...
#ggsave("FS_by_scale_line-plot.jpg", plot = last_plot(), width = 7.5, height = 9, dpi = 500, device = "jpeg")
```
