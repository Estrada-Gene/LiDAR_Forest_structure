...
Visualize spatial patterns of structure variables
```{r}
stand_mets %>%
  dplyr::select(locationID, longitude, latitude, metric_list) %>%
...
Spatial autocorrelation across the entire study area. 
...
stand_mets <- stand_mets %>% mutate(across(c(5:16, 22:25, 27:29, 37), scale, .names = "{.col}.sc"))
```
...
rm1 <- glm(n.all ~  
           ...
           data = stand_mets)
#dredge
rich_models <- dredge(rm1, m.max = 6, 
...
shannon_model <- glm(shannon_ct ~ 
                        ...
                        data = stand_mets)
#dredge
shan_models <- dredge(shannon_model, m.max = 6, 
                      subset = !(basal.area.sc && stand.dens.sc) && 
                               !(basal.area.sc && stem.vol.sc),
                      fixed = "eigenvectors.sc")
...
even_model <- glm(div_even ~ 
              ...
              data = stand_mets)
#dredge
even_models <- dredge(even_model, m.max = 6, 
                      subset = !(basal.area.sc && stand.dens.sc) && 
                               !(basal.area.sc && stem.vol.sc),
                      fixed = "eigenvectors.sc")
...
frich_model <- glm(FRich ~ 
              ...
              data = stand_mets_FD)
#dredge
frich_models <- dredge(frich_model, m.max = 6, 
                      subset = !(basal.area.sc && stand.dens.sc) && 
                               !(basal.area.sc && stem.vol.sc))
...
feven_model <- glm(FEven ~ 
              ...
              data = stand_mets_FD)
#dredge
feven_models <- dredge(feven_model, m.max = 6, 
                      subset = !(basal.area.sc && stand.dens.sc) && 
                               !(basal.area.sc && stem.vol.sc))
...
fdiver_model <- glm(FDiver ~ 
              ...
              data = stand_mets_FD)
#dredge
fdiver_models <- dredge(fdiver_model, m.max = 6, 
                      subset = !(basal.area.sc && stand.dens.sc) && 
                               !(basal.area.sc && stem.vol.sc),
                      fixed = "eigenvectors.sc")
