...
estimates for the functional richness model don't seem to make sense, and since fric is highly correlated with richness (0.81) it makes sense to ignore this model here. Of the other models that have reliable predictors, the shannon and evenness values are also highly correlated (0.89) and both show the same sole predictor as reliable (vFRcanopy), so I also omit the evenness model output here. 
...
kbl(as.data.frame(cbind(cor_matrix, cor_matrix2)), 
    format = "html", 
    caption = "Pearson correlations beteen structure metrics and diversity metrics") %>%
  kable_styling(bootstrap_options = "striped") %>%
  add_header_above(c(" " = 1, "Terrestrial by ct" = 6, "Terrestrial by partition" = 6))
```
