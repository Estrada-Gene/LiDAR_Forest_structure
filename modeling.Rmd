...
#dredge
rich_75_models <- dredge(rm_75, m.max = 3, 
                      subset = !(basal.area.sc && stand.dens.sc) && 
                               !(basal.area.sc && stem.vol.sc) && 
...
#dredge
shan_75_models <- dredge(sm_75, m.max = 3, 
                      subset = !(basal.area.sc && stand.dens.sc) && 
                               !(basal.area.sc && stem.vol.sc) && 
                               !(max.height.sc && mean.tree.h.sc) && 
                               !(max.height.sc && vzrumple.sc) && 
...
#dredge
even_75_models <- dredge(em_75, m.max = 3, 
                      subset = !(basal.area.sc && stand.dens.sc) && 
                               !(basal.area.sc && stem.vol.sc) && 
                               !(max.height.sc && mean.tree.h.sc) && 
                               !(max.height.sc && vzrumple.sc) && 
...
#dredge
frich_75_models <- dredge(fr_75, m.max = 3, 
                      subset = !(basal.area.sc && stand.dens.sc) && 
                               !(basal.area.sc && stem.vol.sc) && 
                               !(max.height.sc && mean.tree.h.sc) && 
                               !(max.height.sc && vzrumple.sc) && 
...
#dredge
feven_75_models <- dredge(fe_75, m.max = 3, 
                      subset = !(basal.area.sc && stand.dens.sc) && 
                               !(basal.area.sc && stem.vol.sc) && 
                               !(max.height.sc && mean.tree.h.sc) && 
                               !(max.height.sc && vzrumple.sc) && 
...
#dredge
fdiver_75_models <- dredge(fd_75, m.max = 3, 
                      subset = !(basal.area.sc && stand.dens.sc) && 
                               !(basal.area.sc && stem.vol.sc) && 
                               !(max.height.sc && mean.tree.h.sc) && 
                               !(max.height.sc && vzrumple.sc) && 
