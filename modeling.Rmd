...
averaged model output - averaging top models (delta AIC values \< 2) when I expand the dAIC values to \<5 zentropy is included and is the strongest (pos) predictor
