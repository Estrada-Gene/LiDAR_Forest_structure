...
#dredge
shan_170_models <- dredge(sm_170, m.max = 2, extra = c("adjR^2", "deviance"),
                      subset = !(basal.area.sc && stand.dens.sc) && 
                               !(basal.area.sc && stem.vol.sc) && 
                               !(max.height.sc && mean.tree.h.sc) && 
                               !(max.height.sc && vzrumple.sc) && 
...
#deviance
summary(shan_170_models$deviance)
```
...
sm_pt1 <- glm(Shannon ~  
           ...
           data = ct_div_mets_terr)
#dredge
shan_pt_models <- dredge(sm_pt1, m.max = 2, extra = c("adjR^2", "deviance"),
                      subset = !(basal.area.sc && stand.dens.sc) && 
                               !(basal.area.sc && stem.vol.sc) && 
                               !(max.height.sc && mean.tree.h.sc) && 
                               !(max.height.sc && vzrumple.sc) && 
...
#deviance
summary(shan_pt_models$deviance)
```
